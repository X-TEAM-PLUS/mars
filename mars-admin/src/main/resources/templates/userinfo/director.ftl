                            ...
                            <div class="col-md-12 pull-right">
                                <form id="userInfoTableForm" onsubmit="init();return false;">
                                    <div class="input-group">
                                        ...
                                        <div class="input-icon col-md-2">
                                            <i class="icon-magnifier"></i>
                                            <input class="form-control" type="text" name="realName" placeholder="用户昵称"/>
                                        </div>
...
<script>
    function init() {
        $("#userInfoTable").pagingGrid(
                {
                    dataUrl: '/services/mars/userinfo/directorList'
                    , pageSize: 10
                    , scroll: false
                    , dockedItems: [{
                        name: '修改'
                        , iconClass: 'fa fa-list-ul'
                        , action: '/mars/userinfo/directorInfo'
                        , confirm: false
                        , parmaName: 'userId'
                        , column: 'userId'
                    }],
