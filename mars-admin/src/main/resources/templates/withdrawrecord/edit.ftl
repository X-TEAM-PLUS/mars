    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/withdrawrecord/put" class="form-horizontal" id="withdrawrecordForm">
                    <input type="hidden" name="id" id="id">

                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                打款账号<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-user-circle "></i>
                                    <input type="text" name="bankAccountNo" class="form-control" placeholder="打款账号" validate='{required: true}'
                                           maxlength="30">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                提取金额<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="amount" class="form-control" placeholder="提取金额" validate='{required: true}'
                                           maxlength="11">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10 date-picker input-daterange " data-date-format="yyyy-mm-dd">
                                    <i class="fa fa-calendar "></i>
                                    <input type="text" name="applyTime" class="form-control" readonly="" validate='{required: true}'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="payWay" class="form-control" placeholder="支付方式" validate='{required: false,digits: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="transactionNo" class="form-control" placeholder="第三方支付流水号" validate='{required: false}'
                                           maxlength="128">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                提款人姓名<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-user "></i>
                                    <input type="text" name="bankAccountName" class="form-control" placeholder="提款人姓名" validate='{required: true}'
                                           maxlength="20">
                                </div>
                            </div>
                        </div>
