                ...
                <div class="portlet-body" id="withdrawRecordTable">
                    ...
                    <table class="table table-striped table-bordered table-hover ">
                        ...
                        <tr>
                            ...
                            <th column="status" type="enum" enum-v="{'-1':'<span class=\'bold badge badge-danger\'>审批未通过</span>',0:'<span class=\'bold badge badge-default\'>未审批</span>',1:'<span class=\'badge badge-success \'>审批通过</span>',2:'<span class=\' bold badge badge-info\'>已打款</span>',3:'<span class=\'bold badge badge-primary \'>已确认</span>',4:'<span class=\'bold badge badge-danger\'>打款失败</span>'}">状态</th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
