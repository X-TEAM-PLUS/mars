    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/withdrawrecord/post" class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    ...
                                    <input type="text" name="bankAccountNo" class="form-control" placeholder="打款账号" validate='{required: true}' maxlength="30">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="amount" class="form-control" placeholder="提取金额" validate='{required: true}' maxlength="11">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="transactionNo" class="form-control" placeholder="第三方支付流水号" validate='{required: false}' maxlength="128">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    ...
                                    <input type="text" name="bankAccountName" class="form-control" placeholder="提款人姓名" validate='{required: true}' maxlength="20">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
