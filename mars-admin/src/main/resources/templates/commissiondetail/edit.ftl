...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            ...
            <a href="index">平台佣金明细表(用于记录每销售一张平台提成的明细)管理</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li class=" active">
    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-adn"></i>编辑平台佣金明细表(用于记录每销售一张平台提成的明细)
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/commissiondetail/put" class="form-horizontal" id="commissiondetailForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    ...
                                    <input type="text" name="ordreNo" class="form-control" placeholder="订单号" validate='{required: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                健康卡号<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="cardNo" class="form-control" placeholder="健康卡号" validate='{required: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                佣金金额<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="commissionAmount" class="form-control" placeholder="佣金金额" validate='{required: true}'
                                           maxlength="11">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                佣金类型<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="commissionType" class="form-control" placeholder="佣金类型" validate='{required: true,digits: true}'
                                    >
                                </div>
                            </div>
                        </div>
...
<script>
    (function ($) {
        $("#commissiondetailForm").ajaxLoadFormData("/services/mars/commissiondetail/get?id=" + getParameter("id"));
    })(jQuery);
</script>
</body>
</html>
