    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-adn"></i>添加平台佣金明细表(用于记录每销售一张平台提成的明细)
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/commissiondetail/post" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="commissionAmount" class="form-control" placeholder="佣金金额" validate='{required: true}' maxlength="11">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
