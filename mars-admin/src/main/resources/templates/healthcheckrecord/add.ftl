    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/healthcheckrecord/post" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    ...
                                    <input type="text" name="checkReport" class="form-control" placeholder="检测报告" validate='{required: true}' maxlength="200">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
