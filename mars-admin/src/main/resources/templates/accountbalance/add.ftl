    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/accountbalance/post" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="balanceAmount" class="form-control" placeholder="余额" validate='{required: true}' maxlength="11">
                                </div>
                            </div>
                        </div>
                    </div>
