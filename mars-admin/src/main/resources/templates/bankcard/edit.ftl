    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-adn"></i>编辑用户银行卡信息表
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/bankcard/put" class="form-horizontal" id="bankcardForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                银行卡账户名称<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10 date-picker input-daterange " data-date-format="yyyy-mm-dd">
                                    <i class="fa fa-calendar "></i>
                                    <input type="text" name="bankAccountName" class="form-control" readonly="" validate='{required: true}'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                用户银行卡ID<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="bankCardId" class="form-control" placeholder="用户银行卡ID" validate='{required: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    ...
                                    <input type="text" name="bankAccountNo" class="form-control" placeholder="银行卡号" validate='{required: true}'
                                           maxlength="20">
                                </div>
                            </div>
                        </div>
