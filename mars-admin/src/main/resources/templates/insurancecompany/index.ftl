    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box grey-cascade">
                ...
                <div class="portlet-body" id="insuranceCompanyTable">
                    <div class="table-toolbar">
                        <div class="row">
                            ...
                            <div class="col-md-2 pull-right">
                                <form id="insuranceCompanyTableForm" onsubmit="init();return false;">
                                    <div class="input-group">
                                        <div class="input-icon">
                                            <i class="icon-magnifier"></i>
                                            <input class="form-control" type="text" name="insuranceCompanyId" placeholder="保险公司ID"/>
                                        </div>
...
<script>
    function init() {
        $("#insuranceCompanyTable").pagingGrid(
                {
                    dataUrl: '/services/mars/insurancecompany/list'
                    , pageSize: 10
                    , scroll: false
                    , dockedItems: [{
                        name: '修改'
                        , iconClass: 'fa fa-edit'
                        , action: '/mars/insurancecompany/edit'
                        , confirm: false
                        , parmaName: 'insuranceCompanyId'
                        , column: 'insuranceCompanyId'
                    }
                        , {
                            name: '删除'
                            , iconClass: 'glyphicon glyphicon-trash'
                            , action: '/services/mars/insurancecompany/delete'
                            , ajax: true
                            , confirm: true
                            , parmaName: 'insuranceCompanyId'
                            , column: 'insuranceCompanyId'
