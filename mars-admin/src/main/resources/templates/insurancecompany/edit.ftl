    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/insurancecompany/put" class="form-horizontal" id="insurancecompanyForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="linkMan" class="form-control" placeholder="联系人" validate='{required: false}'
                                           maxlength="20">
                                </div>
                            </div>
                        </div>
