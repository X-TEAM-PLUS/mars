    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/accountdetail/put" class="form-horizontal" id="accountdetailForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-rmb "></i>
                                    <input type="text" name="amount" class="form-control" placeholder="金额" validate='{required: true}'
                                           maxlength="11">
                                </div>
                            </div>
                        </div>
...
<script>
    (function ($) {
        $("#accountdetailForm").ajaxLoadFormData("/services/mars/accountdetail/get?id=" + getParameter("id"));
    })(jQuery);
</script>
</body>
</html>
