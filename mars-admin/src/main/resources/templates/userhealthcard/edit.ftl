    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-adn"></i>编辑用户健康卡信息表
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/userhealthcard/put" class="form-horizontal" id="userhealthcardForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                已发货次数<span class="required">* </span>
                            </label>
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="sendCount" class="form-control" placeholder="已发货次数" validate='{required: true,digits: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10 date-picker input-daterange " data-date-format="yyyy-mm-dd">
                                    ...
                                    <input type="text" name="cardDeadline" class="form-control" readonly="" validate='{required: false}'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="productType" class="form-control" placeholder="卡类型" validate='{required: true,digits: true}'
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-user-circle "></i>
                                    <input type="text" name="activateUserId" class="form-control" placeholder="激活用户ID" validate='{required: false}'
                                    >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="cardNo" class="form-control" placeholder="卡号" validate='{required: true}'
                                    >
                                </div>
                            </div>
                        </div>
