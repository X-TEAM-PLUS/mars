    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/services/mars/globalconf/put" class="form-horizontal" id="globalconfForm">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa  fa-key "></i>
                                    <input type="text" name="parameterKey" class="form-control" placeholder="参数名" validate='{required: false}'
                                           maxlength="20">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon margin-top-10">
                                    <i class="fa   fa-font "></i>
                                    <input type="text" name="parameterValue" class="form-control" placeholder="参数值" validate='{required: false}'
                                           maxlength="30">
                                </div>
                            </div>
                        </div>
...
<script>
    (function ($) {
        $("#globalconfForm").ajaxLoadFormData("/services/mars/globalconf/get?id=" + getParameter("id"));
    })(jQuery);
</script>
</body>
</html>
