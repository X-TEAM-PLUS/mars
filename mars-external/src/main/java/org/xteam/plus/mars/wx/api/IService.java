...
import org.xteam.plus.mars.wx.util.http.RequestExecutor;
...
public interface IService {
     ...
     * @throws WxErrorException
     */
    WxUserList batchGetUserInfo(List<WxUserList.WxUser.WxUserGet> usersGet) throws WxErrorException;
     ...
     * </pre>
     *
     * @param code oauth2buildAuthorizationUrl()重定向后会携带code
     * @return
     * @throws WxErrorException
     */
     ...
     * </pre>
     *
     * @param WxQrcode里的action_name {@link WxConsts.QR_CODE_LIMIT_SCENE} 临时二维码
