...
public class WxConsts {
    ...
    // 微信代付到用户银行卡(微信商户企业功能)
    public static final String URL_PAY_FOR_ANOTHER_BANK = "https://api.mch.weixin.qq.com/mmpaysptrans/pay_bank";
    // 获取RSA 共钥
    public static final String URL_GET_PUBLIC_KEY = "https://fraud.mch.weixin.qq.com/risk/getpublickey";
    // 微信代付到用户零钱
    public static final String URL_TRANSFERS = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
    /////////////////////////
    //////模板消息
    /////////////////////////
