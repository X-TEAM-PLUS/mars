 ...
 */
@Component
public class MessageRemoveServiceImpl implements GateWayService {
    private final String METHOD_NAME = "cn.zaoangongcheng.api.gateway.security.message.remove";
    ...
    public HttpResponseBody gateWay(HttpRequestBody httpRequestBody) throws Exception {
        if (StringUtils.isNotEmpty(httpRequestBody.getUserId()) && StringUtils.isNotEmpty(httpRequestBody.getBizContent())){
            ...
            if(params !=null && params.containsKey("messageId")){
                int rowCount = messageManager.delete(
                                        new Message()
