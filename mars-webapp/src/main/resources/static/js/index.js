...
$$(document).on('page:init page:reinit page:popupOpen', '.page[data-name="home"]', function (e) {
...
$$(document).on('page:init page:reinit', '.page[data-name="question-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {method: InterFace.QUESTION_LIST}, "question-list", "show-question-list");
});
$$(document).on('page:init  page:reinit', '.page[data-name="message-page"]', function (e) {
    if (sessionStorage.hasOwnProperty(TOKEN)) {
...
$$(document).on('page:init  page:reinit', '.page[data-name="account-info-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.ACCOUNT_INFO,
        token: sessionStorage.getItem(TOKEN)
    }, "account-info", "show-account-info");
});
$$(document).on('page:init page:reinit', '.page[data-name="jiankangka-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
...
$$(document).on('page:init page:reinit', '.page[data-name="heart-card-list-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.USER_HEALTH_CARD_LIST,
        token: sessionStorage.getItem(TOKEN)
    }, "heart-card-list", "show-heart-card-list");
});
$$(document).on('page:init page:reinit', '.page[data-name="lishi-level-user-view"]', function (e) {
    viewMarketingInformation(sessionStorage.getItem(TOKEN));
});
$$(document).on('page:init page:reinit', '.page[data-name="changrenlishi-level-user-view"]', function (e) {
    viewMarketingInformationByLishi(sessionStorage.getItem(TOKEN));
});
$$(document).on('page:init page:reinit', '.page[data-name="wode-baoxian-list-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.USER_INSURANCE_LIST,
        token: sessionStorage.getItem(TOKEN)
    }, "wode-baoxian-list", "show-wode-baoxian-list");
});
$$(document).on('page:init page:reinit', '.page[data-name="wode-baoxian-detail-page"]', function (e) {
...
$$(document).on('page:init page:reinit', '.page[data-name="bankcard-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {method: InterFace.BANK_LIST}, "bank-list", "show-bank-list");
});
$$(document).on('page:init page:reinit', '.page[data-name="zhuanzhang-list-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.USER_WITHDRAW_RECORD_LIST,
        token: sessionStorage.getItem(TOKEN)
    }, "zhuanzhang-list", "show-zhuanzhang-list");
});
$$(document).on('page:init page:reinit', '.page[data-name="butiemingxi-list-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.USER_SUBSIDY_LIST,
        token: sessionStorage.getItem(TOKEN)
    }, "butiemingxi-list", "show-butiemingxi-list");
});
$$(document).on('page:init page:reinit', '.page[data-name="zhuanzhang-form-page"]', function (e) {
    loadBizContent(INTERFACE_URL, {
        method: InterFace.ACCOUNT_AND_BANK_CARD,
        token: sessionStorage.getItem(TOKEN)
    }, "zhuanzhang-form", "show-zhuanzhang-form");
});
$$(document).on('page:init page:reinit', '.page[data-name="show-me-page"]', function (e) {
    loadData(userInfo, "show-me", "show-me-view");
});

$$(document).on('page:init page:reinit', '.page[data-name="heartcheck-page"]', function (e) {
    if (sessionStorage.hasOwnProperty(TOKEN)) {
        getLastCheckInfo(sessionStorage.getItem(TOKEN));
    }
});

$$(document).on('page:init page:reinit', '.page[data-name="employeeCard-page"]', function (e) {
    if (sessionStorage.hasOwnProperty(TOKEN)) {
        getEmployeeCard(sessionStorage.getItem(TOKEN));
    }
});

$$(document).on('page:init page:reinit', '.page[data-name="tijian-result-page"]', function (e) {
    let pageParams = e.detail.route.query;
